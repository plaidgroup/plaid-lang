...
\abstract{
Plaid is an object oriented programming language with explicit typestate. This document defines the core of the Plaid language, including its source syntax, semantics, and type system.
}
