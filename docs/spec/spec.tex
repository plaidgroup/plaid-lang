...
of an object.  Second, Plaid's type system is {\it permission-based}.  The type of each reference 
...
the semantics of crucial operations such as state change, and a type system.
}
