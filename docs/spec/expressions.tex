...
\defspace \keyw{unpackInnerGroups} BlockExpr
...
The \keyw{atomic} expression is used to protect access to shared
...
The \keyw{unpackInnerGroups} is used to gain access to the local data
