...
public class RunCompilerUnitTests {
	protected final static Collection<TestCase> NO_TESTCASES = Collections.emptyList();
	protected final TestCase testCase;
	private final static String frontEndDirectory; static { 
		String testsDir = System.getProperty("user.dir");
		frontEndDirectory = testsDir.substring(0,testsDir.lastIndexOf(System.getProperty("file.separator"))) + "/frontend";
	}
	protected final static ClassLoader cl; static {
		Collection<URL> urls = new ArrayList<URL>();
		try {
			urls.add(new URL("file://" + frontEndDirectory + System.getProperty("file.separator") + "bin" + System.getProperty("file.separator")));
	...
	public RunCompilerUnitTests(TestCase testCase) throws IOException {
	...
	protected static Collection<TestCase> findTestFactories() throws IOException {
		...
		File frontEndDir = new File(frontEndDirectory + System.getProperty("file.separator") + "bin");
		findTestFactories(frontEndDir, frontEndDir, tests);
