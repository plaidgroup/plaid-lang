...
public class RunStdLibUnitTests {
	protected final static Collection<TestCase> NO_TESTCASES = Collections.emptyList();
	protected final TestCase testCase;
	private final static String stdlibDirectory; static { 
		String testsDir = System.getProperty("user.dir");
		stdlibDirectory = testsDir.substring(0,testsDir.lastIndexOf(System.getProperty("file.separator"))) + "/stdlib";
	}
	protected final static ClassLoader cl; static {
		Collection<URL> urls = new ArrayList<URL>();
		try {
			urls.add(new URL("file://" + stdlibDirectory + System.getProperty("file.separator") + "bin" + System.getProperty("file.separator")));
	...
	public RunStdLibUnitTests(TestCase testCase) throws IOException {
	...
	protected static Collection<TestCase> findTestFactories() throws IOException {
		...
		File frontEndDir = new File(stdlibDirectory + System.getProperty("file.separator") + "bin");
