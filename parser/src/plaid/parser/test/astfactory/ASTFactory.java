...
public class ASTFactory {
	public static FieldDecl AbstractFieldDecl(Specifier specifier, TypeDeclaration type, Identifier name) {
		return new AbstractFieldDecl(ASTNode.DEFAULT_TOKEN, Modifier.EMPTY, specifier, type, name);
	}
	
	public static MethodDecl AbstractMethodDecl(List<Modifier> modifiers, TypeDeclaration type, Identifier name, List<StaticArg> metaArgs, List<Arg> args, List<Arg> env) {
		return new AbstractMethodDecl(ASTNode.DEFAULT_TOKEN, modifiers, type, name, metaArgs, args, env);
	}

	public static MethodDecl AbstractMethodDecl(TypeDeclaration type, Identifier name, List<StaticArg> metaArgs, List<Arg> args, List<Arg> env) {
	...
	public static ArgSpec ArgSpec(TypeDeclaration preType) {
		return new ArgSpec(null, preType, TypeDeclaration.EMPTY);
	}
	
	public static ArgSpec ArgSpec(TypeDeclaration preType, TypeDeclaration postType) {
	...
	public static Cast Cast(Expr e, TypeDeclaration type) {
	...
	public static FieldDecl ConcreteFieldDecl(Specifier specifier, TypeDeclaration type, Identifier name, Expr body) {
		return new ConcreteFieldDecl(ASTNode.DEFAULT_TOKEN, Modifier.EMPTY, specifier, type, name, body);
	}
	
	public static MethodDecl ConcreteMethodDecl(TypeDeclaration type, Identifier name, List<StaticArg> metaArgs, List<Arg> args, List<Arg> env, BlockExpr body) {
	...
	public static LambdaType LambdaType(List<ArgSpec>argsSpec, TypeDeclaration returnType) {
		return new LambdaType(null,new ArrayList<StaticType>(),argsSpec,
				new ArrayList<Arg>(), returnType);
	}

	public static LambdaType LambdaType(TypeDeclaration returnType) {
	...
	public static VarDecl VarDecl(Specifier specifier, TypeDeclaration type, Identifier field, Expr value) {
