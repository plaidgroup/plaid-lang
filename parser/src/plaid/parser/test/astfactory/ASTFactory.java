...
public class ASTFactory {
	...
	public static NewInstance NewInstance(State state) {
	...
	public static StateChange StateChange(Expression e, State state) {
		return new StateChange(ASTNode.DEFAULT_TOKEN, e, state);
	}
	
	public static Replace Replace(Expression e, State state) {
