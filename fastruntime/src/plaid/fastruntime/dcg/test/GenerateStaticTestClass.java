...
public class GenerateStaticTestClass {
	...
	public  void test() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		...
		Assert.assertTrue(newTestClassJavaObject instanceof TestClass);
		Assert.assertTrue(((TestClass) newTestClassJavaObject).s.equals("noArgs"));
		...
		Assert.assertTrue(newTestClassJavaObject2 instanceof TestClass);
		Assert.assertTrue(((TestClass) newTestClassJavaObject2).s.equals("foo"));
		...
		Assert.assertTrue(newTestClassJavaObject3 instanceof TestClass);
		Assert.assertTrue(((TestClass) newTestClassJavaObject3).s.equals("object object"));
		...
		Assert.assertTrue(newTestClassJavaObject4 instanceof TestClass);
		Assert.assertTrue(((TestClass) newTestClassJavaObject4).s.equals("object foo"));
