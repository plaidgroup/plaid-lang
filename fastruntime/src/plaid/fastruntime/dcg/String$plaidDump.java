...
mv.visitMethodInsn(INVOKESPECIAL, "plaid/fastruntime/reference/SimplePlaidJavaObject", "<init>", "(Lplaid/fastruntime/PlaidState;Lplaid/fastruntime/PlaidObject[];Ljava/lang/Object;)V");
mv.visitLabel(l1);
